...
const createResult = (score, maxScore) => ({
...
useEffect(() => {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      ...
      >
        <Stack.Screen name="AppNavigatorNext" component={AppNavigatorNext} />
      </Stack.Navigator>
    );
  };
